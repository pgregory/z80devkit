...
describe('RLA', function() {
  beforeEach(function() {
    ...
    this.cleanRegs = {}
    const code = new Uint8Array([0x17])
  ...
  describe('borrow carry, result in carry', function() {
    beforeEach(function() {
  ...
  describe('borrow carry, result in no carry', function() {
    beforeEach(function() {
    ...
    it('should set the expected result', function() {
      assert.equal(this.z80.reg8[this.z80.regOffsets8.A], 0x81, 'A == 0x81')
    })
    it('should advance the PC by 1', function() {
      assert.equal(this.z80.reg16[this.z80.regOffsets16.PC], this.initReg16[this.z80.regOffsets16.PC] + 1, 'PC = PC + 1')
    })
  ...
  describe('no borrow, result in carry', function() {
    beforeEach(function() {
      this.z80.reg8[this.z80.regOffsets8.A] = 0xC0
  ...
  describe('no borrow, result in no carry', function() {
    beforeEach(function() {
      this.z80.reg8[this.z80.regOffsets8.A] = 0x40
      this.z80.flags.C = false
      this.z80.stepExecution()
