...
describe('ADC', function() {
  ...
  // ADC HL, HL
  describe.skip('ADC HL, HL', function() {
    makeMath16Test('add with C == 1 resulting in carry', 'ADC', 'HL', 'HL', 0x8181, 0x8181, 0x0303, [0xED, 0x6A], 2, {C: true, N: false}, ["PC", "HL"], {C: true})
    makeMath16Test('add with C == 0 resulting in carry', 'ADC', 'HL', 'HL', 0x8181, 0x8181, 0x0302, [0xED, 0x6A], 2, {C: true, N: false}, ["PC", "HL"], {C: false})
    makeMath16Test('add with C == 1 resulting in zero', 'ADC', 'HL', 'HL', 0x8000, 0x7FFF, 0x0000, [0xED, 0x6A], 2, {Z: true, N: false}, ["PC", "HL"], {C: true})
    makeMath16Test('add with C == 0 resulting in zero', 'ADC', 'HL', 'HL', 0x0000, 0x0000, 0x0000, [0xED, 0x6A], 2, {Z: true, N: false}, ["PC", "HL"], {C: false})
    makeMath16Test('add with C == 1 resulting in overflow', 'ADC', 'HL', 'HL', 0x8888, 0x8888, 0x1111, [0xED, 0x6A], 2, {P: true, N: false}, ["PC", "HL"], {C: true})
    makeMath16Test('add with C == 0 resulting in overflow', 'ADC', 'HL', 'HL', 0x8888, 0x8888, 0x1110, [0xED, 0x6A], 2, {P: true, N: false}, ["PC", "HL"], {C: false})
  })
})
